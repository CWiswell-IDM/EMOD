...
def application( output_folder="output",
    ...
    sft.wait_for_done()
    config_object = parse_config_file(config_filename, debug=debug)
    # Load config file: Simulation_Duration, Enable_Termination..., Minimum_End_Time

    chart_object = parse_json_report(output_folder=output_folder)
    # Load inset chart: get statistical population channel and infected channel

    create_report_file(config_object=config_object, report_object=chart_object,
